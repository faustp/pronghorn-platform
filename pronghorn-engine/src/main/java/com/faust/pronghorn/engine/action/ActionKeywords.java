package com.faust.pronghorn.engine.action;


import com.faust.pronghorn.common.validation.Validate;
import com.faust.pronghorn.engine.data.Constant;
import com.faust.pronghorn.engine.data.DocObjectModel;
import com.faust.pronghorn.engine.data.ObjectType;
import com.faust.pronghorn.engine.exception.ActionKeywordException;
...
public class ActionKeywords {
    ...
    public static void storeInfo(IExtentTestClass report, Script script, String testCaseId) {
        try {
            String info;
            if (DocObjectModel.getType(script.getSelector().getKey()) == ObjectType.TXTBOX) {
                info = WEB_DRIVER.findElement(By.cssSelector(script.getSelector().getValue())).getAttribute("value");
            } else if (DocObjectModel.getType(script.getSelector().getKey()) == ObjectType.LIST_BOX) {
